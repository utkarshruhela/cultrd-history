...
const EXPECTED_STILL_ONGOING = new Set([
  ...
  "afghan-durrani-and-modern-state",
  "canada-confederation-and-modern-state",
  "swiss-confederation-continuity",
  "independent-samoa",
  "independent-belize",
  "commonwealth-of-dominica",
  "saint-kitts-and-nevis-modern-federation",
  "saint-lucia-modern-state",
  "trinidad-and-tobago-modern-state",
  "grenada-modern-state",
  "saint-vincent-and-grenadines-modern-state",
  "kingdom-of-eswatini-modern-state",
  "republic-of-liberia-modern-state",
  "kingdom-and-republic-of-iceland",
  "tunisian-modern-state",
  "albanian-modern-state",
  "republic-of-botswana-modern-state",
  "barbados-modern-state",
  "algerian-modern-state",
  "republic-of-angola-modern-state",
  "republic-of-finland-modern-state",
  "co-operative-republic-of-guyana",
  "republic-of-the-gambia-modern-state",
  "republic-of-malawi-modern-state",
  "republic-of-kenya-modern-state",
  "state-of-eritrea-modern-state",
  "commonwealth-of-the-bahamas-modern-state",
  "republic-of-uganda-modern-state",
  "united-republic-of-tanzania-modern-state",
  "togolese-republic-modern-state",
  "republic-of-equatorial-guinea-modern-state",
  "kingdom-of-lesotho-modern-state",
  "republic-of-suriname-modern-state",
  "republic-of-mozambique-modern-state",
  "republic-of-the-sudan-modern-state",
  "gabonese-republic-modern-state",
  "federal-republic-of-nigeria-modern-state",
  "republic-of-panama-modern-state",
  "revolutionary-and-contemporary-cuba",
  "federal-republic-of-brazil-modern-state",
  "postwar-japan-constitutional-state",
  "commonwealth-of-australia-modern-state",
  "republic-of-lithuania-modern-state",
  "federation-of-malaysia-modern-state",
  "republic-of-rwanda-modern-state",
  "republic-of-senegal",
  "republic-of-yemen",
  "mexican-republic-modern-state",
  "argentine-republic-modern-state",
  "kingdom-of-belgium-modern-state",
  "republic-of-chile-modern-state",
  "republic-of-colombia-modern-state",
  "republic-of-peru-modern-state",
  "republic-of-guatemala-modern-state",
  "antigua-and-barbuda-independent-state",
  "sierra-leone-independent-state",
  ...
  "republic-of-honduras-modern-state",
  "republic-of-nicaragua-modern-state",
  "republic-of-venezuela-modern-state",
  "bulgarian-state-modern-continuity",
  "romanian-state-modern-continuity",
  "modern-greek-state",
