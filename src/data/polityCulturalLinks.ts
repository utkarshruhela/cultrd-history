...
export const POLITY_CULTURAL_LINKS: PolityCulturalLink[] = [
  ...
  { polityId: "ancient-egypt", culturalWorkId: "book-of-the-dead", relationship: "produced", start: -1700, end: -1700, note: "The approximate date marks the funerary collection's early use, not the copying of every surviving papyrus. This association uses the atlas's broad Egyptian profile, without implying a single royal commission.", confidence: "medium" },
  { polityId: "ancient-egypt", culturalWorkId: "edwin-smith-papyrus", relationship: "produced", start: -1600, end: -1600, note: "The date refers to the surviving manuscript. Its anonymous scribes and medical traditions cannot be assigned securely to a particular royal patron; Egypt was politically divided during this period.", confidence: "medium" },
  { polityId: "abbasid-caliphate", culturalWorkId: "al-kindi-first-philosophy", relationship: "produced", start: 833, end: 842, note: "Al-Kindi worked in the Abbasid court milieu and dedicated this treatise to al-Mu'tasim. A dedication establishes a court connection, not necessarily an explicit commission.", confidence: "high" },
  ...
  { polityId: "restoration-england-ireland-map", culturalWorkId: "principia-newton", relationship: "produced", start: 1687, end: 1687, note: "Newton's Principia was published in England within the territories grouped by this composite map label. This does not imply Irish authorship, a parliamentary union, or a royal commission.", confidence: "high" },
  { polityId: "medieval-kingdom-of-england", culturalWorkId: "principia-newton", relationship: "produced", start: 1687, end: 1687, note: "Newton's Principia was published in England in 1687, with Edmond Halley overseeing and financing publication. It predates the 1707 creation of Great Britain and is not a royal commission.", confidence: "high" },
  { polityId: "united-kingdom-great-britain-ireland-1801-1922", culturalWorkId: "on-the-origin-of-species", relationship: "produced", start: 1859, end: 1859, note: "John Murray published Darwin's first edition in London on 24 November 1859. This locates the book's publication within the United Kingdom, without attributing its international evidence base to state sponsorship.", confidence: "high" },
